...
import kafka.spark.scala.movie.analysis.Constants._
import kafka.spark.scala.movie.analysis.MovieUtils._
...
object KafkaConsumerStreaming {
  ...
  def main(args: Array[String]): Unit = {
    ...
    def makeRow(line: List[String]): Row = Row(line.head.toLong, line(1), line(2), line(3), line(4), line(5), line(6), line(7), line(8), line(9),
      line(10), line(11), line(12), line(13), line(14), line(15), line(16), line(17), line(18), line(19))

    lines.foreachRDD((rdd, _) => {
      ...
      getMoviesWithBudgetAndGenre(movieDf, spark).show(50, truncate = false)
    })

    // setting the check point directory
    ssc.checkpoint(checkPointDirectory)
    // starting the streaming context and awaiting termination
    ssc.start()
